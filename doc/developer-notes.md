...
BCash is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 19801.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 19800 for connections and services them.
...
However, in open source software such as BCash, where everyone uses
...
pay attention to for reviewers of BCash code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BCash uses tinyformat, which is type safe. Leave them out to avoid confusion
