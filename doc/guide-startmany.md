...
[From the bcash github repo](https://github.com/bcashpay/bcash/blob/master/doc/masternode_conf.md)
...
If you generated a new masternode private key, you will need to update the remote `bcash.conf` files.

Shut down the daemon and then edit the file.

```nano .bcashcore/bcash.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `bcash.conf` file.
...
Search your Masternodes on https://bcashninja.pl/masternodes.html
