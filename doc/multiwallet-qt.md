...
Only requiring some minor changes is bcash.cpp.
...
Changes to bcash.cpp
----------------------
bcash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
