 ...
 *
 *   // network
 *   CBCashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bcashpay.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBCashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BCashNetwork
// //   -- signature requirements : Key1(User)
// class CBCashNetworkVariable : public CGovernanceObject
// {
// private:
