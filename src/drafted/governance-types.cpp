...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BCashNetwork") type = BCashNetwork;
    if(strType == "BCashNetworkVariable") type = BCashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BCashNetwork) s = "BCashNetwork";
    if(type == BCashNetworkVariable) s = "BCashNetworkVariable";
