...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all BCash related functionality
...
/*
    ...
    allow endless transaction that would bloat BCash and make it unusable. To
