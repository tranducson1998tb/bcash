...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BCash"), this);
    aboutAction->setStatusTip(tr("Show information about BCash"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BCash"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BCash help message to get a list with possible BCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BCash client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BCash network", "", count));
    } else {
