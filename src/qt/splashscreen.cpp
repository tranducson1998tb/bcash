    ...
    QWidget(0, f), curAlignment(0)
{
	...
	QString copyrightTextBCash   = QChar(0xA9)+QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The BCash developers"));
	...
	pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+24,copyrightTextBCash);
