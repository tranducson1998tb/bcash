...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 3000;         // 3000 BCASH
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 1519344000;	// OFF
